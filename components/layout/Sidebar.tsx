...
export default function Sidebar({ expanded, onToggle }: SidebarProps) {
  ...
  const [flyout, setFlyout] = useState<{ label: string; y: number } | null>(null);
      ...
      <aside className="sidebar" style={{
        ...
        <div style={{
          ...
          <Link href="/superadmin" style={{ textDecoration: 'none', flexShrink: 0 }}>
            <div style={{
              ...
              fontWeight: 700, fontSize: 13, color: '#fff', letterSpacing: '-0.02em',
              ...
              {allItems.map(item => {
                ...
                return (
                  <Link
                    ...
                    style={{
                      display: 'flex', alignItems: 'center', justifyContent: 'center',
                      height: 34, borderRadius: active ? '0 8px 8px 0' : 8, flexShrink: 0,
        ...
        <div style={{
          ...
          <div style={{ width: 200, display: 'flex', flexDirection: 'column', height: '100%' }}>
            {/* Panel header */}
            <div style={{ padding: '16px 14px 10px', flexShrink: 0, borderBottom: '1px solid var(--sidebar-border)' }}>
              <div style={{
                fontFamily: 'var(--font-heading)',
              ...
              {visibleGroups.map((group, gi) => {
                ...
                return (
                  <div key={group.section}>
                    {gi > 0 && (
                      <div style={{ borderTop: '1px solid var(--sidebar-border)', margin: '4px 8px 6px' }} />
                    )}
                    ...
                    <div style={{ borderTop: '1px solid var(--sidebar-border)', margin: '3px 8px 2px' }} />
            ...
            {/* User block */}
            <div style={{ borderTop: '1px solid var(--sidebar-border)', padding: 14, flexShrink: 0 }}>
              {admin && (
